...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"VirtualCameraManager_WinRT.CustomCameraKsPropertyInquiry"))
    {
        return winrt_make_VirtualCameraManager_WinRT_CustomCameraKsPropertyInquiry();
    }

    if (requal(name, L"VirtualCameraManager_WinRT.VirtualCameraRegistrar"))
    {
        return winrt_make_VirtualCameraManager_WinRT_VirtualCameraRegistrar();
    }
